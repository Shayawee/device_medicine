...
?>
    ...
    <div>
    <a href="admin_how_to_use.php"><button>วิธีการใช้งาน</button></a>
    </div>
    <div>
    ...
    while($row=mysqli_fetch_array($result)) {
      ...
      <div class = "device">
        ...
        <a href="admin_detail_device.php?med_id=<?=$row["med_id"]?>"><button>ประวัติเครื่องมือแพทย์</button></a><br><br>
        
        <a href="delete_device.php?med_id=<?=$row["med_id"]?>" onclick="Del (this.href);return false;"><button>ลบเครื่องมือแพทย์</button></a>
